...
import pytest
from episodic_vector_store.models import FrontierPayload, ExecutionStatus
from episodic_vector_store.engine import FrontierDomainEngine
from episodic_vector_store.agents import HNSWGraphBuilderAgent, CosineDistanceSearcherAgent, PersistentStorageEngineAgent, EpisodicMemoryCoordinator
from episodic_vector_store.cli import main


def test_sub_agents():
    a1 = HNSWGraphBuilderAgent()
    ...
    a2 = CosineDistanceSearcherAgent()
    ...
    a3 = PersistentStorageEngineAgent()
...
def test_coordinator():
    coord = EpisodicMemoryCoordinator()
    ...
    assert "HNSW Vector Indexing Specification" in ans or "specifications" in ans
