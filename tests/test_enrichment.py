"""
Automated Pytest for long-term-episodic-vector-db Enrichment Modules.
"""
import sys
...
from enrichment import (
    EpisodicReplayForTrainingEngine,
    CrossagentEpisodeSharingEngine,
    TemporalDecayOnEmbeddingsEngine,
    EpisodeClusteringEngine,
    EpisodeExportToCsvEngine,
    LongtermepisodicvectordbEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = LongtermepisodicvectordbEnrichmentSuite()
