"""
Data Models & Telemetry Definitions for EpisodicVector-Store: Hierarchical HNSW & Cross-Session Memory Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "HNSW Vector Indexing Specification"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
