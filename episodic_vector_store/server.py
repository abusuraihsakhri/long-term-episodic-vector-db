"""
FastAPI REST API Server for EpisodicVector-Store: Hierarchical HNSW & Cross-Session Memory Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="EpisodicVector-Store: Hierarchical HNSW & Cross-Session Memory Agent",
            description="Implements pure Python Hierarchical Navigable Small World (HNSW) vector graphs with cosine similarity for fast long-term memory retrieval.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "long-term-episodic-vector-db", "domain": "Autonomous Context Management & State Engines", "version": "2.0.0-FRONTIER"}
